...
Using Gradio for Python 3.14 compatibility
"""
...
def chat(message, history):
    ...
    try:
        ...
        return f"❌ Error: {redact_sensitive(str(e))}"
...
demo = gr.ChatInterface(
    fn=chat,
    title="🌤️ Azure OpenAI Weather Agent",
    description="Ask me about weather in Mumbai, Delhi, Bangalore, Chennai, New York, London, or Tokyo!",
    examples=[
        "What's the weather in Mumbai?",
        "Give me a 5-day forecast for New York",
        "Compare weather in Delhi and London",
    ],
)
